; =================================================================
; V53 Monitor System v0.11 2026-02-25
...
.init_loop:
    ...
    out  dx, al
    ;------------------------------------------
    ; ICU レジスタ配置アドレスの設定 (IULA) 0x2080
    ;------------------------------------------
    mov dx, IULA
    mov al, 0x80    ; 下位アドレス
    out dx, al
    ;------------------------------------------
    ; TCU レジスタ配置アドレスの設定 (TULA) 0x2070
    ;------------------------------------------
    mov dx, TULA
    mov al, 0x70    ; 下位アドレス
    out dx, al
    ;------------------------------------------
    ; SCU レジスタ配置アドレスの設定 (SULA) 0x2060
    ;------------------------------------------
    mov dx, SULA
    mov al, 0x60    ; 下位アドレス
    out dx, al
...
; Data
; =================================================================
msg_boot: db 0x0D,0x0A,"**  V53 RAM MONITOR v0.11 2026-02-25  **",0x0D,0x0A,0
